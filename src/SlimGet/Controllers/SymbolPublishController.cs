...
namespace SlimGet.Controllers
{
    ...
    public class SymbolPublishController : NuGetControllerBase
    {
        ...
        public SymbolPublishController(SlimGetContext db, RedisService redis, IFileSystemService fs, IOptions<StorageConfiguration> storcfg, PackageProcessingService pkgParser)
